  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M17.982 18.725A7.488 7.488 0 0012 15.75a7.488 7.488 0 00-5.982 2.975m11.963 0a9 9 0 10-11.963 0m11.963 0A8.966 8.966 0 0112 21a8.966 8.966 0 01-5.982-2.275M15 9.75a3 3 0 11-6 0 3 3 0 016 0z" />
     ...
     <div class="mt-8">
         <!-- <ul v-for="item in result" :key="item.index">
          ...
          <div class="gitemIndex gitemIndex-flow-row gitemIndex-cols-1 md:gitemIndex-cols-2 lg:gitemIndex-cols-3 xl:gitemIndex-cols-4 gap-10">
          <li >
          ...
          <div class="p-5">
           ...
           <div class="bg-black h-5 w-5 rounded-full shadow-md mr-2">
            ...
            <div class="flex flex-row my-3">
             ...
             <div class="flex flex-row justify-between">
              <button v-on:click="AddToCart(item)"  class="bg-gradient-to-r from bg-red-600 to bg-pink-700 rounded-full py-2 px-4 text-gray-50 flex flex-row text-sm
                hover:from-pink-600 hover:to-pink-600 ">
                 <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 mr-1 ">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 00-16.536-1.84M7.5 14.25L5.106 5.272M6 20.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm12.75 0a.75.75 0 11-1.5 0 .75.75 0 011.5 0z" />
                </svg>
...
export default {
  ...
  /*  Data show and placed with the help of local storage  
    
    item_fun(itemIndex) {
            console.warn(itemIndex, this.result[itemIndex]);
            let temp, x;
            // y,z;
            // let set;
            ...
            x = temp[itemIndex - 1].title;
            console.warn(temp[itemIndex - 1].title);
            // y=temp[itemIndex - 1].price;
            // z=temp[itemIndex - 1].image;
  ...
  methods: {
    ...
    item_fun(itemIndex) {
        ...
        AddToCart(productData){
            alert("hello Cart Item page")
              console.warn(productData);
              alert("Your Product is Added in the Cart")
              // this.$store.state.cart="hyperzod"
                  // this.$store.commit('setCart',"Hyperzod")
              this.$store.dispatch('addItem',"hyperzod")
              // if(productData)
              // {
              // this.addedPrducts.push(pid);
              //  localStorage.setItem("products_data",JSON.stringify(this.addedPrducts));
