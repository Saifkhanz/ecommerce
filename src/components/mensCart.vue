  ...
  <div>
    ...
    <div class="grid grid-flow-row grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-10">
     <div class="shadow-lg rounded-lg ">
      <a >  
      <img src="../assets/t-shirt.jpg" class="rounded-tl-lg rounded-tr-lg" />  
      </a>
      <div class="p-5">
          <h3><a >Men's T-Shirt</a></h3>
       ...
       <div class="bg-black h-5 w-5 rounded-full shadow-md mr-2">
        ...
        <div class="flex flex-row my-3">
         ...
         <div class="flex flex-row justify-between">
            <button v-on:click="fun"  :v-model="cart" class="bg-gradient-to-r from bg-red-600 to bg-pink-700 rounded-full py-2 px-4 text-gray-50 flex flex-row text-sm
            hover:from-pink-600 hover:to-pink-600 ">
             ...
             <router-link to="/orderspage" class="bg-blue-600 rounded-full py-2 px-4 text-gray-50 flex flex-row 
      ...
      <div class="p-5">
       ...
       <div class="bg-black h-5 w-5 rounded-full shadow-md mr-2">
        ...
        <div class="flex flex-row my-3">
         ...
         <div class="flex flex-row justify-between">
            <button v-on:click="fun"  class="bg-gradient-to-r from bg-red-600 to bg-pink-700 rounded-full py-2 px-4 text-gray-50 flex flex-row text-sm
            hover:from-pink-600 hover:to-pink-600 ">
             <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 mr-1 ">
              <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 00-16.536-1.84M7.5 14.25L5.106 5.272M6 20.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm12.75 0a.75.75 0 11-1.5 0 .75.75 0 011.5 0z" />
            </svg>
...
export default {
  name:"mensCart",
   ...
   methods:{
    ...
    {    
      // this.count++;
      alert('Your Items successfully added in the cart');
    }
