<template>
  <div>
   ...
   <h4 class="text-3xl text-grey-700 ml-3">Accounts Page</h4>
   </div>
   </div>
     <div class="container bg-slate-500">
      <main class="grid grid-cols-2 bg-red-200">
      <div id="profile">
...
<!-- <div id="drawer-navigation" class="fixed z-40 h-screen p-4 overflow-y-auto bg-white w-80 dark:bg-gray-800 transition-transform left-0 top-0 transform-none" tabindex="-1" aria-labelledby="drawer-navigation-label" aria-modal="true" role="dialog">
...
<div class="fixed z-40 h-screen p-4 overflow-y-auto bg-white w-80 dark:bg-gray-800 transition-transform left-0 top-0 transform-none" tabindex="-1" aria-labelledby="drawer-navigation-label" aria-modal="true" role="dialog">
